...
class VSSBlock(nn.Module):
    ...
    def forward(self, input_x: torch.Tensor, input_y: torch.Tensor):
        if self.use_checkpoint:
...
class VSSM(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.patch_embed_hsi = _make_patch_embed(in_chans_hsi, dims[0], patch_size, patch_norm, norm_layer, channel_first=self.channel_first)
        self.patch_embed_lidar = _make_patch_embed(in_chans_lidar, dims[0], patch_size, patch_norm, norm_layer, channel_first=self.channel_first)
    ...
    def forward(self, x: torch.Tensor, y: torch.Tensor):
        ...
        self.visualize_feature_map(feature_map_z, 'mm_vit_code/z_A_6_feature_map.png')
        #######     feature visualization    ########    
        return x, y, z
