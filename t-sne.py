...
colors_all = ["#66C5CC", "#F6CF71", "#F89C74", "#DCB0F2", "#87C55F", "#9EB9F3", "#FE88B1",
              ...
              "#FF9DA7"]   
# colors_all = ["#F6CF71", "#66C5CC", "#F89C74", "#DCB0F2", "#9EB9F3", "#87C55F", "#FE88B1",
#               "#8BE0A4", "#C9DB74", "#11A579", "#7F3C8D", "#3969AC", "#E73F74", "#A5AA99",
#               "#FF9DA7"]
...
if __name__ == '__main__':
    ...
    plt.savefig('./visual_result_clip/' + 'MUFFL_no_loss_tsne.png')
    plt.show()
