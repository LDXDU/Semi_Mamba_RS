...
def get_inputs_data(use_data):
    if use_data == 'Houston2013':
        img1 = loadmat('/home/data2/cmx/HSI_LIDAR/data_begin/Houston2013/HSI.mat')['HSI']
        img2 = loadmat('/home/data2/cmx/HSI_LIDAR/data_begin/Houston2013/LiDAR_1.mat')['LiDAR']
    elif use_data == 'MUFFL':
        img1 = loadmat('/home/data2/cmx/HSI_LIDAR/data_begin/MUFFL/hsi.mat')['HSI']

        img2 = loadmat('/home/data2/cmx/HSI_LIDAR/data_begin/MUFFL/lidar.mat')['lidar']
        ...
        img1 = loadmat('/home/data2/cmx/HSI_LIDAR/data_begin/Augsburg/data_hsi.mat')['data']

        img2 = loadmat('/home/data2/cmx/HSI_LIDAR/data_begin/Augsburg/data_sar.mat')['data']
    if len(img1.shape) == 2:
...
if __name__ == '__main__':
    ...
    save_weights_path = '/home/data2/cmx/save_weights_MUFFL/300e_9vssblock_0ka_accsave_bs8_1e4_loss/100epoch.pth'
    ...
    Image.fromarray(seg_out.astype(np.uint8)).save('./visual_result_clip/' + 'MUFFL_no_loss.png')
